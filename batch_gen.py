...
class BatchGenerator(object):
    def __init__(self, num_classes, actions_dict,coa_actions_dict, gt_path, features_path, sample_rate):
    ...
    def next_batch(self, batch_size, flag,coarse_on=True):
        ...
        batch_coa_target_tensor = torch.ones(len(batch_input), max(length_of_sequences), dtype=torch.long) * (-100)#####
