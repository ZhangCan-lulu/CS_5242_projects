...
parser.add_argument('--coarse_mode', type=str, default='early', choices=['none', 'early', 'late','all'], help='choose whether use coarse classifier ')
...
pre_inx="new_noatt_coarse_onehot"
...
if args.action == "train":
    batch_gen_source = BatchGenerator(num_classes, actions_dict,coa_actions_dict, gt_path, features_path, sample_rate)
    batch_gen_target = BatchGenerator(num_classes, actions_dict,coa_actions_dict, gt_path, features_path, sample_rate)
